...
public CompressionVID(int fact) {}
String par=null; String filename="";String name="";String ext="";
File inp=null;File com=null;File dec=null;

public static void main(String args[]) throws Exception {
CompressionVID cv=new CompressionVID(5);long start=System.currentTimeMillis();
File fi=new File("C:\\Users\\bilal.iqbal\\Pictures\\FILES\\sample\\wildlife.wmv");cv.init(fi);
cv.compressVideo(cv.inp,cv.com);System.out.println("video Compressed");
cv.decompressVideo(cv.com,cv.dec);System.out.println("video DECompressed");
...
double CRF=0;
long ABR=(long)(bitrate/(factor-.1f));
...
output=new File(out.substring(0, out.lastIndexOf('.'))+"_.mp4");
FileInputStream fis=null;
InputStream is=null;
OutputStream os=null;
try {
